...
var _default = session => {
  ...
  class CouchDBStore extends Store {
     ...
     */
    constructor(options) {
      options = options || {}; // const { unsecured, ...options } = options;
      ...
      if (options.unsecured) {
        ...
        this.connection = (0, _nano.default)(this.generateUnsecuredConnectionURL());
      } else {
    ...
    generateUnsecuredConnectionURL() {
      return "http://".concat(this.hostname, ":").concat(this.port);
    }
    /**
